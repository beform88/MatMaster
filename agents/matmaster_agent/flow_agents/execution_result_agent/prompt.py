...
- When involving literature research or parsing results, output the **EXACT RAW RESULTS directly without additional commentary** from `matmaster_sync_mcp_event`.
"""
