...
NMRAgentInstruction = (
    ...
    '2. **NMR_predict**: Predict 1H and 13C NMR chemical shifts for given molecular structures (SMILES). '
    ...
    '- smiles_list: List of SMILES strings for molecules to predict NMR spectra '
    '\n'
