...
VASPKIT_BOHRIUM_EXECUTOR['machine']['remote_profile'][
    'image_address'
] = 'registry.dp.tech/dptech/dp/native/prod-16664/vaspkit-agent:0.0.1'

VASPKIT_BOHRIUM_EXECUTOR['machine']['remote_profile']['machine_type'] = 'c2_m8_cpu'
