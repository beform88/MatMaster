...
ALL_TOOLS = {
    'abacus_modify_input': {'belonging_agent': ABACUS_AGENT_NAME, 'scene': []},
    'abacus_modify_stru': {'belonging_agent': ABACUS_AGENT_NAME, 'scene': []},
    'abacus_collect_data': {'belonging_agent': ABACUS_AGENT_NAME, 'scene': []},
    'abacus_calculation_scf': {'belonging_agent': ABACUS_AGENT_NAME, 'scene': []},
    'abacus_badercharge_run': {'belonging_agent': ABACUS_AGENT_NAME, 'scene': []},
    'abacus_cal_band': {'belonging_agent': ABACUS_AGENT_NAME, 'scene': []},
    'abacus_cal_elf': {'belonging_agent': ABACUS_AGENT_NAME, 'scene': []},
    'abacus_cal_charge_density_difference': {
        'belonging_agent': ABACUS_AGENT_NAME,
        'scene': [],
    },
    'abacus_cal_spin_density': {'belonging_agent': ABACUS_AGENT_NAME, 'scene': []},
    'abacus_dos_run': {'belonging_agent': ABACUS_AGENT_NAME, 'scene': []},
    'abacus_cal_elastic': {'belonging_agent': ABACUS_AGENT_NAME, 'scene': []},
    'abacus_eos': {'belonging_agent': ABACUS_AGENT_NAME, 'scene': []},
    'abacus_phonon_dispersion': {'belonging_agent': ABACUS_AGENT_NAME, 'scene': []},
    'abacus_do_relax': {'belonging_agent': ABACUS_AGENT_NAME, 'scene': []},
    'abacus_vibration_analysis': {'belonging_agent': ABACUS_AGENT_NAME, 'scene': []},
    'abacus_run_md': {'belonging_agent': ABACUS_AGENT_NAME, 'scene': []},
    'run_abacus_calculation': {'belonging_agent': ABACUS_AGENT_NAME, 'scene': []},
    'apex_calculate_vacancy': {'belonging_agent': ApexAgentName, 'scene': []},
    'apex_optimize_structure': {'belonging_agent': ApexAgentName, 'scene': []},
    'apex_calculate_interstitial': {'belonging_agent': ApexAgentName, 'scene': []},
    'apex_calculate_elastic': {'belonging_agent': ApexAgentName, 'scene': []},
    'apex_calculate_surface': {'belonging_agent': ApexAgentName, 'scene': []},
    'apex_calculate_eos': {'belonging_agent': ApexAgentName, 'scene': []},
    'apex_calculate_phonon': {'belonging_agent': ApexAgentName, 'scene': []},
    'apex_calculate_gamma': {'belonging_agent': ApexAgentName, 'scene': []},
    'get_target_info': {'belonging_agent': CHEMBRAIN_AGENT_NAME, 'scene': []},
    'unielf_inference': {'belonging_agent': CHEMBRAIN_AGENT_NAME, 'scene': []},
    'plan_and_visualize_reaction': {
        'belonging_agent': CHEMBRAIN_AGENT_NAME,
        'scene': [],
    },
    'convert_smiles_to_png': {'belonging_agent': CHEMBRAIN_AGENT_NAME, 'scene': []},
    'convert_png_to_smiles': {'belonging_agent': CHEMBRAIN_AGENT_NAME, 'scene': []},
    'validate_smiles': {'belonging_agent': CHEMBRAIN_AGENT_NAME, 'scene': []},
    'run_ga': {'belonging_agent': COMPDART_AGENT_NAME, 'scene': []},
    'extract_material_data_from_pdf': {
        'belonging_agent': DocumentParserAgentName,
        'scene': [],
    },
    'optimize_structure': {'belonging_agent': DPACalulator_AGENT_NAME, 'scene': []},
    'run_molecular_dynamics': {'belonging_agent': DPACalulator_AGENT_NAME, 'scene': []},
    'calculate_phonon': {'belonging_agent': DPACalulator_AGENT_NAME, 'scene': []},
    'calculate_elastic_constants': {
        'belonging_agent': DPACalulator_AGENT_NAME,
        'scene': [],
    },
    'run_neb': {'belonging_agent': DPACalulator_AGENT_NAME, 'scene': []},
    'finetune_dpa_model': {'belonging_agent': FinetuneDPAAgentName, 'scene': []},
    'HEA_params_calculator': {'belonging_agent': HEA_assistant_AgentName, 'scene': []},
    'HEA_predictor': {'belonging_agent': HEA_assistant_AgentName, 'scene': []},
    ...
    'semantic_search': {'belonging_agent': PerovskiteAgentName, 'scene': []},
    'plot_vs_time': {'belonging_agent': PerovskiteAgentName, 'scene': []},
    'run_piloteye': {'belonging_agent': PILOTEYE_ELECTRO_AGENT_NAME, 'scene': []},
    'deep_research_agent': {'belonging_agent': SSEBRAIN_AGENT_NAME, 'scene': []},
    ...
    'screen_superconductor': {'belonging_agent': SuperconductorAgentName, 'scene': []},
    ...
    'traj_analysis_msd': {'belonging_agent': TrajAnalysisAgentName, 'scene': []},
    'traj_analysis_rdf': {'belonging_agent': TrajAnalysisAgentName, 'scene': []},
    'traj_analysis_solvation': {'belonging_agent': TrajAnalysisAgentName, 'scene': []},
    'traj_analysis_bond': {'belonging_agent': TrajAnalysisAgentName, 'scene': []},
    'traj_analysis_react': {'belonging_agent': TrajAnalysisAgentName, 'scene': []},
}
