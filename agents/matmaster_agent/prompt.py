...
- **General requirement:** A space should be added between figures and units, e.g. 10 cm, 5 kg. An italic font should be used for physical quantities; A bold font should be used for vectors;
