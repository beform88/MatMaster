...
class CrystalformerAgent(BaseAsyncJobAgent):
    def __init__(self, llm_config):
        super().__init__(
            ...
            submit_core_agent_name=CrystalformerSubmitCoreAgentName,
