...
from opik.evaluation.metrics import base_metric, score_result, AnswerRelevance
    ...
    def score(
        ...
        try:
            if function_call:
                ...
                return AnswerRelevance(name=self.name, model=self.model, require_context=False).score(input=input,
                                                                                                      output=output)
